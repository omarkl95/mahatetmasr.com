...
(function () {
	...
	$(function () {
		...
		if (isDesktop && !isNoviBuilder) {
			$().UItoTop({
				...
				containerClass: 'ui-to-top mdi fas fa-arrow-up'
			});
		}
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF255': 'Messag sent Successfully.'
  ...
  /*----------------------------
   Navbar nav
  ------------------------------ */
  var main_menu = $(".rd-navbar-nav-wrap ul.rd-navbar-nav li ");
